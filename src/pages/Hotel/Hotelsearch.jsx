...
const Homeform = (props) => {
  ...
  const [offersToggle1, setOffersToggle1] = useState(1)
         ...
         try">
              ...
              >
                ...
                <Grid item xs={12} sm={5.5} md={2} id="hero2" className="hero" onMouseEnter={() => {
                  ...
                  <div >
                    ...
                    }} > {date.slice(8, 10)} </h1><span>{MonthDayInEnglish1.slice(0, 3)} {date.slice(2, 4)}</span>
                    <p variant="p" sx={{
          ...
          <div className="OFFERS">
            <div className="OFFERS1">
              ...
              <div>
                <div onClick={() => setOffersToggle(1)} className={offersToggle === 1 ? " chanege" : ""}  >
                  <div className="chanege_active" />
                  <div />
                  <div />
                  <div />
                  <div />
