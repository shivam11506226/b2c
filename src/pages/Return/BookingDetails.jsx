  ...
  return (
    <div className="container7">
      ...
      <div className="flight-info-container">
        ...
        <div className="aircraft-type1">
          <div className="badge1">
            <div className="badge-content1">Airbus A320</div>
          </div>
        </div>
      </div>
      ...
      <div className="traveler-info">
        <div className="traveler-details">
          ...
          <div>
            ...
            <span className="traveler-details">
              xyz@gmail.com | +91 - xxxxxxx
            </span>
          </div>
        </div>
      </div>
